...
- Updated the [Inbound and Outbound Webhooks](./local-integrations/local-webhooks.md) page: added webhook creation scenarios, GET request examples for quick method testing, and limitations for production integrations
