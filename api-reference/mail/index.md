# E-mail in REST 3.0: section overview
...
E-mail in Bitrix24 allows you to work with e-mails directly in the interface: read and send e-mails, filter correspondence, link e-mails to the CRM, and also create a chat, a task, a calendar event, or a Feed message from an e-mail.
