...
The method `landing.landing.copyblock` copies a block to the specified page and returns the identifier of the created block copy. You can copy a block from another page or within the same page. The HTML content of the block is also copied.
...
The block identifier can be obtained using the method [landing.block.getList](../../block/methods/landing-block-get-list.md). The block can be on another page or on the same page `lid`.
...
If you pass the identifier of an existing block on the page `lid`, the copy will be inserted immediately after it. If the parameter is not passed, `0` is passed, or the identifier of a block that does not exist on the page `lid` is specified, the copy will be added to the end of the page ||
|| **RETURN_CONTENT**
[`string`](../../../data-types.md) | If `Y` is passed, the method will return an object with a success indicator and the data of the created block copy [(detailed description)](#result-content). For any other value, the method will return only the identifier of the created block copy ||
|#
...
```json
{
    ...
    "time": {
        ...
        "processing": 0,
        "date_start": "2026-03-19T18:01:20+02:00",
        "date_finish": "2026-03-19T18:01:20+02:00",
...
If `params.RETURN_CONTENT = 'Y'` is passed, instead of the block identifier, the method will return an object with a success indicator and the data of the created block copy.

### Example Response with `RETURN_CONTENT = 'Y'`
...
```json
{
    ...
    "time": {
        ...
        "processing": 0,
        "date_start": "2026-03-19T18:12:44+02:00",
        "date_finish": "2026-03-19T18:12:44+02:00",
...
`type` | **Description** ||
|| **result**
[`integer`](../../../data-types.md) \| [`object`](../../../data-types.md) | Identifier of the created block copy. If `params.RETURN_CONTENT = 'Y'` is passed, the method will return an object with a success indicator and block data [(detailed description)](#result-content) ||
|| **time**
[`time`](../../../data-types.md#time) | Information about the execution time of the request ||
|#

### Object result with `RETURN_CONTENT = 'Y'` {#result-content}
...
|| **content**
[`object`](../../../data-types.md) | Data of the created block copy [(detailed description)](#content) ||
|#
...
`type` | **Description** ||
|| **id**
[`integer`](../../../data-types.md) | Identifier of the created block copy ||
|| **sections**
...
|| **js**
[`array`](../../../data-types.md) | List of JS resources for the block and related client libraries that need to be connected for its operation. 
...
|| **requiredUserAction**
[`array`](../../../data-types.md) | This field contains the same data as `manifest.requiredUserAction`. It is returned only when the user must perform additional actions on the client side after copying the block ||
|#
...
|| `BLOCK_NOT_FOUND` | Source block with identifier `block` not found, not accessible to the current user, marked as deleted, or cannot be loaded from the source page ||
|#
