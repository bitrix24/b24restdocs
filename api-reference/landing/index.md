...
2. Next, it's time for the page. Similarly, create a page or select from existing ones. ([Methods](./page/index.md) for working with the page.)
3. Blocks. Blocks are the molecules of websites (nodes – atoms). You should have a good understanding of what a [block](./block/index.md) is and what its [manifest](./block/manifest.md) entails. You can work with blocks in the context of a page (adding, moving, deleting) using [these methods](./page/block-methods/index.md). To work with a specific block, use [these methods](./block/methods/index.md).
...
|| [landing.site.getPreview](./site/landing-site-get-preview.md) | Returns the URL of the website preview image. | 21.800.0 ||
...
|| [landing.role.isEnabled](./rights/landing-role-is-enabled.md) | Determines rights models. ||
|#
...
#| 
|| **Method** | **Description** ||
|| [landing.role.getList](./rights/role-model/landing-role-get-list.md) | Method allows you to get the list of roles. ||
|| [landing.role.getRights](./rights/role-model/landing-role-get-rights.md) | Method allows you to get the list of websites for which rights are set within the role. ||
...
|| [landing.landing.removeEntities](./page/methods/landing-landing-remove-entities.md) | Method removes related entities of the landing page. | ||
...
|| [landing.landing.markundeletedblock](./page/block-methods/landing-landing-mark-undeleted-block.md) | Method restores a block from the marked deleted state. | ||
...
|| [landing.landing.showblock](./page/block-methods/landing-landing-show-block.md) | Method for displaying a block on the page. | ||
...
#| 
|| **Method** | **Description** ||
|| [landing.syspage.deleteForLanding](./page/special-pages/landing-syspage-delete-for-landing.md) | Deletes all bindings of the page as a special one. ||
|| [landing.syspage.deleteForSite](./page/special-pages/landing-syspage-delete-for-site.md) | Deletes all special pages. ||
|| [landing.syspage.getSpecialPage](./page/special-pages/landing-syspage-get-special-page.md) | Gets the address of the special page of the website. ||
|| [landing.syspage.get](./page/special-pages/landing-syspage-get.md) | Gets the list of special pages. ||
|| [landing.syspage.set](./page/special-pages/landing-syspage-set.md) | Sets a special page for the website. ||
|#
...
|| [landing.block.uploadfile](./block/methods/landing-block-upload-file.md) | Method uploads an image and links it to the specified block. | ||
...
|| [landing.block.addcard](./block/methods/landing-block-add-card.md) | Method fully replicates the work of [landing.block.clonecard](./block/methods/landing-block-clone-card.md) but allows you to insert a card with modified content immediately. | ||
...
|| [landing.site.bindingToMenu](./embedding/knowledge-base/landing-site-binding-to-menu.md) | Embeds into the menu. ||
