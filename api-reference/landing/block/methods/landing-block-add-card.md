...
|| **selector*** 
[`string`](../../../data-types.md) | Selector of the card from the [key `cards` of the block manifest](../manifest.md#cards-key)
...
For more details on card selectors and the structure of the manifest, refer to the article [Block Manifest](../manifest.md#cards-key) ||
|| **content*** 
