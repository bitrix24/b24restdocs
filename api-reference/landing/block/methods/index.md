...
|| [landing.block.removecard](./landing-block-remove-card.md) | Method for removing a block card. | ||
...
|| [landing.block.addcard](./landing-block-add-card.md) | Method fully replicates the functionality of [landing.block.clonecard](./landing-block-clone-card.md) but allows inserting a card with modified content immediately. | ||
|| [landing.block.updateCards](./landing-block-update-cards.md) | Method for bulk updating block cards. | ||
|| [landing.block.changeAnchor](./landing-block-change-anchor.md) | Method for changing the symbolic code of the anchor. | ||
