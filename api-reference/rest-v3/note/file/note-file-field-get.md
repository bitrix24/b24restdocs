# Get Document File Field note.file.field.get
...
The `note.file.field.get` method retrieves a description of a document file field by name.
...
- `requiredGroups` — requiredness groups
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/note.file.field.get`
