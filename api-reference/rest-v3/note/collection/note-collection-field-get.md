# Get Knowledge Base Field note.collection.field.get
...
The `note.collection.field.get` method retrieves a Knowledge base field description by name.
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/note.collection.field.get`
