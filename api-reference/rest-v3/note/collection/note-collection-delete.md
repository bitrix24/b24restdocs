# Move Knowledge Base to Shopping Cart note.collection.delete
...
The `note.collection.delete` method moves a knowledge base to the shopping cart and cascades the move to all its documents.
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/note.collection.delete`
...
Error Code: `NOTE_COLLECTION_UNDER_IMPORT`

HTTP status: **409**

#|
|| **Field** | **Error description** | **How to Fix** ||
|| `id` | A background import of documents is being performed for the knowledge base | Wait for the import to complete and retry the request ||
|#
