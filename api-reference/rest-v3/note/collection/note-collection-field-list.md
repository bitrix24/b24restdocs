# Get a List of Knowledge Base Fields note.collection.field.list
...
The `note.collection.field.list` method returns a list of available Knowledge base fields.
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/note.collection.field.list`
