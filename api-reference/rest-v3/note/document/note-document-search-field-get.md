# Get Document Search Field note.document.search.field.get
...
The `note.document.search.field.get` method returns a description of the document search result field by name.
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/note.document.search.field.get`
