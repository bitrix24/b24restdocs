# Get a List of Document Fields note.document.field.list
...
The `note.document.field.list` method returns a list of available document fields.
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/note.document.field.list`
