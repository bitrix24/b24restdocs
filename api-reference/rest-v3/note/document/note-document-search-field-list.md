# Get a List of Document Search Fields note.document.search.field.list
...
The `note.document.search.field.list` method returns a list of available fields for the document search result.
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/note.document.search.field.list`
