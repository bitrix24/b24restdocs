...
The `ONTASKCOMMENTUPDATE` event is triggered after a comment in a task is changed.
...
In this case — `ONTASKCOMMENTUPDATE` ||
|| **data***
[`object`](../../../data-types.md) | An object containing data about a comment change event.
...
[`integer`](../../../data-types.md) | Identifier of the task to which the comment belongs ||
|| **ACTION***
[`string`](../../../data-types.md) | Action, which in this case will always be `EDIT` ||
|#
