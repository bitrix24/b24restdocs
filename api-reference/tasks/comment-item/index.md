...
{% note warning "Comments Do Not Work with Module Version `tasks 25.700.0`" %}
...
The [task.commentitem.delete](./task-comment-item-delete.md) method deletes a comment with the result.
...
- Methods
    ...
    || [task.commentitem.get](./task-comment-item-get.md) | Retrieves a task comment by `id` ||
