# Delete Task v 3.0 tasks.task.delete
...
The task identifier can be obtained when [creating a new task](./tasks-task-add-rest-v3.md) or through the old method of [getting the list of tasks](./tasks-task-list-rest-v3.md) ||
|#
