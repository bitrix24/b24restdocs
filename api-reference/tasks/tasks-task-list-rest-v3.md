# Get Task List v 3.0 tasks.task.list
...
Field names for `select` match the keys of the task object from the [Task object](./fields-rest-v3.md#taskdto) block ||
|| **filter**
...
See the field descriptions in the [Task object](./fields-rest-v3.md#taskdto) block
