# Get Task by ID v 3.0 tasks.task.get
...
For related objects, use a nested path with a dot, for example `["responsible.name","responsible.email"]` - the response will include the `responsible` object with the requested fields. [List of fields with related objects](./fields-rest-v3.md)
||
|#
...
|| **item**
[`object`](../data-types.md) | Object with task field values. [Description of task fields with related objects](./fields-rest-v3.md) ||
|| **time**
