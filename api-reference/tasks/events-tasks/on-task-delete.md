...
The `ONTASKDELETE` event is triggered after a task is deleted.
...
In this case — `ONTASKDELETE` ||
|| **data***
[`object`](../../data-types.md) | An object containing data about the task deletion event.
