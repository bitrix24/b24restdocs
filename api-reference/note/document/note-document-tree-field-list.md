# Get a List of Document Tree Fields note.document.tree.field.list
...
The `note.document.tree.field.list` method returns a list of available document tree fields.
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/note.document.tree.field.list`
