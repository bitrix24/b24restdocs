...
1. Create a waitlist entry using [booking.v1.waitlist.add](./booking-v1-waitlist-add.md) or move data from a booking using [booking.v1.waitlist.createfrombooking](./booking-v1-waitlist-createfrombooking.md)
2. Add a client using [booking.v1.waitlist.client.*](./client/index.md)
3. If necessary, link a deal using [booking.v1.waitlist.externalData.*](./external-data/index.md)
4. Track changes through [waitlist events](./events/index.md)
