...
|| `ACCESS_DENIED` | Access denied. The application is trying to change a payment system added by another application, or lacks permissions to change the payment system | 403 ||
