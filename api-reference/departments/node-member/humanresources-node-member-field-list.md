# Retrieve a List of Department Member Fields humanresources.node.member.field.list
...
The method `humanresources.node.member.field.list` returns a list of available fields for a department or team member.
...
```text
https://{installation_address}/rest/api/{user_id}/{webhook_token}/humanresources.node.member.field.list
```
