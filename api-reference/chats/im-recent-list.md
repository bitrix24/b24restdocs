# Get List of Chats im.recent.list

> Scope: [`im`](../scopes/permissions.md)
>
> Who can execute the method: any user

The method `im.recent.list` retrieves a list of the user's recent dialogues with pagination support.
...
- `N` — no ||
|| **SKIP_DIALOG**
[`string`](../data-types.md) | Skip one-on-one dialogues.
...
|| **UNREAD_ONLY**
[`string`](../data-types.md) | Return only dialogues with unread messages.
...
[`string`](../data-types.md) | Skip undistributed Open Channels chats.
...
`type` | **Description** ||
|| **items**
[`array`](../data-types.md) | List of recent dialogues [(detailed description)](#items-item) ||
|| **hasMorePages**
...
|| **messagesAutoDeleteConfigs**
[`array`](../data-types.md) | Auto-delete message settings by chats ||
|#
...
`type` | **Description** ||
|| **id**
[`string`](../data-types.md) | Identifier of the dialogue: number for user, `chatXXX` for chat ||
|| **chat_id**
...
|| **title**
[`string`](../data-types.md) | Title of the record: user name or chat name ||
|| **message**
[`object`](../data-types.md) | Last message in the dialogue [(detailed description)](#items-item-message) ||
|| **counter**
[`integer`](../data-types.md) | Unread message counter ||
|| **last_id**
[`integer`](../data-types.md) | Identifier of the last read message ||
|| **pinned**
[`boolean`](../data-types.md) | Indicator of a pinned dialogue ||
|| **unread**
[`boolean`](../data-types.md) | Indicator of a manual "unread" mark ||
|| **has_reminder**
[`boolean`](../data-types.md) | Indicator of a set reminder ||
|| **date_update**
[`datetime`](../data-types.md) | Date of the last change in the dialogue in ISO 8601 format ||
|| **date_last_activity**
[`datetime`](../data-types.md) | Date of the last activity in the dialogue in ISO 8601 format ||
|| **user**
...
|| **color**
[`string`](../data-types.md) | Color of the dialogue in HEX format ||
|#
...
|| **mobile_last_date**
[`datetime`](../data-types.md) | Date of the user's last activity in the mobile app. If not set, `false` ||
|| **desktop_last_date**
[`datetime`](../data-types.md) | Date of the user's last activity in the desktop app. If not set, `false` ||
|| **absent**
...
|| **mute_list**
[`array`](../data-types.md) | List of users with disabled notifications ||
|| **manager_list**
