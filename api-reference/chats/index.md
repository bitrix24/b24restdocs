...
|| [im.v2.File.upload](../chat-bots/chat-bots-v2/im.v2/files/file-upload.md) | Uploads a file to the chat using the new API ||
|| [im.v2.File.download](../chat-bots/chat-bots-v2/im.v2/files/file-download.md) | Returns a link to download the file using the new API ||
|#

## Events

For new scenarios for receiving chat events, use the `im.v2` section. It contains methods for subscribing to user events in the messenger, receiving events in polling mode, and describing payload formats.

#|
|| **Method** | **Description** ||
|| [im.v2: events](../chat-bots/chat-bots-v2/im.v2/events/index.md) | Overview of working with events in the new API ||
|| [im.v2.Event.subscribe](../chat-bots/chat-bots-v2/im.v2/events/event-subscribe.md) | Subscribes to event recording ||
|| [im.v2.Event.get](../chat-bots/chat-bots-v2/im.v2/events/event-get.md) | Returns accumulated events ||
|| [im.v2.Event.unsubscribe](../chat-bots/chat-bots-v2/im.v2/events/event-unsubscribe.md) | Stops event recording ||
|| [im.v2 Event Formats](../chat-bots/chat-bots-v2/im.v2/events/events.md) | Description of events and data structures ||
|#
...
#|
|| **Method** | **Description** ||
|| [im.notify.answer](./notifications/im-notify-answer.md) | Responds to a notification supporting quick reply ||
...
|| [im.notify.read.list](./notifications/im-notify-read-list.md) | Reads the list of notifications (excluding CONFIRM) ||
...
|| [im.search.last.delete](./search/im-search-last-delete.md) | Removes search from history ||
...
|| [im.recent.pin](./special-operations/im-recent-pin.md) | Pins a chat to favorites ||
...
|| [im.user.status.idle.start](./users/im-user-status-idle-start.md) | Enables the automatic "Away" status ||
