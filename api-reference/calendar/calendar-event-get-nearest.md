...
|| **forCurrentUser**
[`boolean`](../data-types.md) | Output the list of events for the current user. ||
|| **maxEventsCount**
[`integer`](../data-types.md) | Maximum number of events to display. ||
|| **detailUrl**
[`string`](../data-types.md) | URL for the calendar. ||
|#
...
|| **OWNER_ID**
[`string`](../data-types.md) | Identifier of the user (if the calendar type is `user`) or group (if the calendar type is `group`) ||
|| **NAME**
...
- count [`integer`](../data-types.md) - numerical value of the time interval. ||
  ...
  || **RRULE**
  [`object`](../data-types.md) | Event recurrence. In terms of the iCalendar standard:
...
- entityId [`string`](../data-types.md) - type of entity of the event participant;
...
|| Empty string | Access denied | Access to the calendar type is prohibited or the calendar functionality is not activated for the user ||
|#
