...
|| **SETTINGS***
[`array`](../../data-types.md) | Example of a parameter with a complex nested structure. At this level, we describe it in general terms, without all the details - just to provide an overall understanding. Later, specific keys like CONFIG or ITEMS will be described in subsequent tables with separate subheadings.
