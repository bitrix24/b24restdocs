...
The `OnOpenLineMessageDelete` event triggers when a message is deleted in an open line chat.
...
In this case — `ONOPENLINEMESSAGEDELETE` ||
|| **eventId***
...
|| **DATA***
[`array`](../../../data-types.md) | An array of objects with deleted message data.
...
`type` | **Description** ||
|| **im***
[`object`](../../../data-types.md) | An object with information about a deleted message in a chat.

The structure is described [below](#im) ||
|| **message***
[`object`](../../../data-types.md) | An object with information about a message.

The structure is described [below](#message) ||
|| **chat***
[`object`](../../../data-types.md) | An object with information about a chat.
