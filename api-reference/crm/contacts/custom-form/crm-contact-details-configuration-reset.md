...
>  - any user can reset their own personal settings
>  - a user with the "Allow to change settings" access permission in CRM can reset the shared settings and another user's personal settings
