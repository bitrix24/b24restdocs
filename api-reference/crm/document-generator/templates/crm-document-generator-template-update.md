...
|| **file**
[`file`](../../../data-types.md) | Template file in the format `["file_name.docx", "base64_content"]`. Can be sent in `base64` or `multipart/form-data`. More details: [How to Upload Files](../../../files/how-to-upload-files.md) ||
|| **numeratorId**
