...
The event `onCrmRequisiteDelete` is triggered when a requisite is deleted.
...
`type` | **Description** ||
|| **event***
[`string`](../../../data-types.md) | Symbolic code of the event. In this case, it is `onCrmRequisiteDelete`||
|| **data***
[`array`](../../../data-types.md) | Array containing the data of the deleted requisite ||
|| **ts***
...
`type` | **Description** ||
|| **FIELDS***
[`array`](../../../data-types.md) | Array containing the fields of the deleted requisite ||
|#
