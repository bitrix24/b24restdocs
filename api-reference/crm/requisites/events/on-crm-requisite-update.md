...
In this case — `onCrmRequisiteUpdate` ||
|| **data***
[`object`](../../../data-types.md) | An object containing the data of the changed requisite.

Contains a single key `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | An object containing the fields of the changed requisite.
