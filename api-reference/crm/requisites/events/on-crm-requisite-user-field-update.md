...
In this case — `onCrmRequisiteUserFieldUpdate` ||
|| **data***
[`object`](../../../data-types.md) | An object containing data from the modified custom field of the payment detail.

Contains a single key `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | An object containing fields of the modified custom field of the payment detail.
