...
In this case — `onCrmRequisiteUserFieldSetEnumValues` ||
|| **data***
[`object`](../../../data-types.md) | An object containing the data of the custom field of the payment detail for which the set of values was changed.

Contains a single key `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | An object containing the fields of the custom field of the payment detail for which the set of values was changed.
