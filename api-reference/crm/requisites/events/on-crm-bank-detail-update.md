...
In this case — `onCrmBankDetailUpdate` ||
|| **data***
[`object`](../../../data-types.md) | An object containing the modified bank details data.

Contains a single key `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | An object containing the fields of the modified bank details.
