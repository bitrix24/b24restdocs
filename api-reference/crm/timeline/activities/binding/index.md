...
2. Determine the `entityTypeId` and `entityId` of the CRM object.
3. Add the binding of the deal to the CRM object using the [crm.activity.binding.add](./crm-activity-binding-add.md) method.
...
#| 
|| **Method** | **Description** ||
|| [crm.activity.binding.add](./crm-activity-binding-add.md) | Adds a binding of the deal to a CRM object ||
|| [crm.activity.binding.move](./crm-activity-binding-move.md) | Moves the binding of the deal to another CRM object of the same type ||
|| [crm.activity.binding.list](./crm-activity-binding-list.md) | Returns a list of the deal's bindings ||
|| [crm.activity.binding.delete](./crm-activity-binding-delete.md) | Deletes the binding of the deal from the CRM object ||
|#