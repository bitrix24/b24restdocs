...
The method `crm.stagehistory.list` returns records of stage history for the following elements:
...
- `5` — invoice (old),
- `31` - invoice (new),
- numeric identifier of [custom type](./universal/user-defined-object-types/index.md#id)
||
|| **order**
...
`type` | **Description** ||
|| **result**
[`array`](../data-types.md) | Root element of the response, contains an array of records [items](#items). Each object is an array with keys ||
|| **time**
