...
The method `crm.enum.activitynotifytype` returns activity start notification types for the `NOTIFY_TYPE` field of [activities](../../../timeline/activities/index.md) — meetings and calls.
