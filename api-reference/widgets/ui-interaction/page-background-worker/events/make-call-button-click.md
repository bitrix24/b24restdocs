# When Clicking the "Call" or "Callback" Button BackgroundCallCard::makeCallButtonClick
...
The `BackgroundCallCard::makeCallButtonClick` event occurs when a call is started from the call card.
