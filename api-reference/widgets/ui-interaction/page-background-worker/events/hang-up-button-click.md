# When Clicking the "End" Button BackgroundCallCard::hangupButtonClick
...
The `BackgroundCallCard::hangupButtonClick` event occurs when the button that ends the active conversation is clicked.
