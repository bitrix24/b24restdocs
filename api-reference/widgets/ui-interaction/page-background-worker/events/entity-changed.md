...
- the call card opened and pulled up the client data from the CRM. In this case, the event may arrive earlier than [BackgroundCallCard::initialized](./initialized.md)
