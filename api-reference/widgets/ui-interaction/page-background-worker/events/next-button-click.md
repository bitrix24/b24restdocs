# When Clicking the "Next" Button BackgroundCallCard::nextButtonClick
...
The `BackgroundCallCard::nextButtonClick` event occurs when the operator moves on to the next client in call campaign mode.
