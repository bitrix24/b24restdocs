# Dropdown Menu Item of the Top Button in the CRM_XXX_ROBOT_DESIGNER_TOOLBAR

> Scope: [`intranet`](../../scopes/permissions.md)

You can add your dropdown menu item to the top button of the robot designer for CRM entities such as [leads](../../crm/leads/index.md) and [deals](../../crm/deals/index.md).
