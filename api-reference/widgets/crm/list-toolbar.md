...
|| The item is not visible above the list of elements | Click the arrow next to the button on the right side of the panel above the list: the item is displayed in this menu, next to the knowledge base and Bitrix24 Market items ||
|#
