# Widget in the Task Card TASK_VIEW_SIDEBAR
...
The widget adds the application interface to the task card. Until module version `tasks` 25.700.0 it was rendered in the right sidebar; in the [new card](../../tasks/tasks-new.md) it is a row in the *Applications* block.
...
|| `TASK_VIEW_SIDEBAR` | Row in the *Applications* block of the task card ||
|#
...
![Row in the Applications block of the task card](./_images/TASK_VIEW_SIDEBAR.png "Row in the Applications block of the task card")
