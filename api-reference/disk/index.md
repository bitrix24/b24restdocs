...
1. Get available storages using the [disk.storage.getList](./storage/disk-storage-get-list.md) method
2. Get files and folders in the storage root using the [disk.storage.getChildren](./storage/disk-storage-get-children.md) method
3. Create a folder or upload a file using the [disk.folder.addSubFolder](./folder/disk-folder-add-subfolder.md) and [disk.folder.uploadFile](./folder/disk-folder-upload-file.md) methods
4. Manage files using the [disk.file.*](./file/index.md) methods and folders using the [disk.folder.*](./folder/index.md) methods
5. Configure access through permission levels from [disk.rights.getTasks](./rights/disk-rights-get-tasks.md)
