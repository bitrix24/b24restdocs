# Get Fields and Settings of Shipment Properties for a Specific Type sale.shipmentproperty.getfieldsbytype
...
`type` | **Description** ||
|| **type***
[`string`](../../data-types.md) | Type of shipment property
Possible values:
`STRING`
`Y/N`
`NUMBER`
