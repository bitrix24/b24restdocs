...
`type` | **Description** ||
|| **ID***
[`catalog_price.id`](../data-types.md#catalog_price) | Price identifier. You can retrieve all fields of the price by its identifier using the method [catalog.price.get](../price/catalog-price-get.md) ||
|#
