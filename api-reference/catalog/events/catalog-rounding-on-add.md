...
`type` | **Description** ||
|| **ID***  
[`catalog_rounding_rule.id`](../data-types.md#catalog_rounding_rule) | Identifier of the price rounding rule. You can retrieve all fields of the price rounding rule by its identifier using the method [catalog.roundingRule.get](../rounding-rule/catalog-rounding-rule-get.md) ||
|#
