...
`type` | **Description** ||
|| **ID***
[`catalog_measure.id`](../data-types.md#catalog_measure) | Identifier of the unit of measurement. You can retrieve all fields of the unit of measurement by its identifier using the [catalog.measure.get](../measure/catalog-measure-get.md) method ||
|#
