...
The `CATALOG.ROUNDING.ON.DELETE` event is triggered when a price rounding rule is deleted.
...
In this case — `CATALOG.ROUNDING.ON.DELETE` ||
|| **event_handler_id***
[`integer`](../../../data-types.md) | Identifier of the event handler ||
|| **data***
[`object`](../../../data-types.md) | An object containing information about a remote price rounding rule.

Contains a single key `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | An object containing information about the fields of the price rounding rule.
