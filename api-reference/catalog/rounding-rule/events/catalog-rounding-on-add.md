...
The `CATALOG.ROUNDING.ON.ADD` event is triggered when a price rounding rule is added.
...
In this case — `CATALOG.ROUNDING.ON.ADD` ||
|| **event_handler_id***
[`integer`](../../../data-types.md) | Identifier of the event handler ||
|| **data***
[`object`](../../../data-types.md) | An object containing information about the added price rounding rule.
