...
#|
|| **Event** | **Triggered** ||
|| [CATALOG.PRICE.TYPE.ON.ADD](./catalog-price-type-on-add.md) | When a price type is added manually or using [catalog.priceType.add](../catalog-price-type-add.md) ||
|| [CATALOG.PRICE.TYPE.ON.UPDATE](./catalog-price-type-on-update.md) | When a price type is updated manually or using [catalog.priceType.update](../catalog-price-type-update.md) ||
|| [CATALOG.PRICE.TYPE.ON.DELETE](./catalog-price-type-on-delete.md) | When a price type is deleted manually or using [catalog.priceType.delete](../catalog-price-type-delete.md) ||
|#
