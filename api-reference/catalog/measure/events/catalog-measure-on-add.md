...
The `CATALOG.MEASURE.ON.ADD` event is triggered when a unit of measurement is added.
...
In this case — `CATALOG.MEASURE.ON.ADD` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Identifier of the event handler ||
|| **data***
[`object`](../../data-types.md) | An object containing information about the added unit of measurement.
