...
The `CATALOG.MEASURE.ON.DELETE` event is triggered when a unit of measurement is deleted.
...
In this case — `CATALOG.MEASURE.ON.DELETE` ||
|| **event_handler_id***
[`integer`](../../../data-types.md) | Identifier of the event handler ||
|| **data***
[`object`](../../../data-types.md) | An object containing information about a remote unit of measurement.
