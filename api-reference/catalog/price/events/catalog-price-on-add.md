...
The `CATALOG.PRICE.ON.ADD` event is triggered when a price is added.
...
In this case — `CATALOG.PRICE.ON.ADD` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Identifier of the event handler ||
|| **data***
[`object`](../../data-types.md) | An object containing information about the added price.
