...
The `CATALOG.PRICE.ON.UPDATE` event is triggered when a price is updated.
...
In this case — `CATALOG.PRICE.ON.UPDATE` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Identifier of the event handler ||
|| **data***
[`object`](../../data-types.md) | An object containing information about the updated price.
