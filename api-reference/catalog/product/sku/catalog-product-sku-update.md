# Update Main Product Fields catalog.product.sku.update
...
|| **fields***
[`object`](../../../data-types.md) | Field values to update the main product ||
|#
...
For main products, the ability to edit this field is available only in the on-premise version when the option "Show the Trade Catalog tab for products with trade offers" is enabled.
||
|| **createdBy**
...
|| 
|| `0` | Specified purchasing currency does not exist
|| 
