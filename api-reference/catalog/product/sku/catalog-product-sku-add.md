...
This method adds a parent product to the trading catalog.
...
`type` | **Description** ||
|| **iblockId***
[`catalog_catalog.id`](../../data-types.md#catalog_catalog) | Identifier of the information block of the trading catalog.

To obtain existing identifiers of information blocks in trading catalogs, use [catalog.catalog.list](../../catalog/catalog-catalog-list.md)
||
|| **name***
...
For parent products, the ability to edit this field is available only in the on-premise version with the option "Show the Trading Catalog tab for products with trade offers" enabled.
||
|| **createdBy**
...
When adding a parent product, the property value can be specified as a string, number, or as an object `{value: value}`. If the property is multiple, an array of values or objects of the form `{value: value}` should be specified. ||
|#
...
```json
{
    "result": {
        "sku": {
            ...
            "sort": 100,
            "subscribe": "Y",
            "timestampX": "2024-06-18T08:06:07+02:00",
            "type": 3,
            "vatId": 1,
            "vatIncluded": "Y",
            "weight": 100,
    ...
    "time": {
        ...
        "date_start": "2024-06-18T10:06:06+02:00",
        "date_finish": "2024-06-18T10:06:07+02:00"
    }
}
```
...
|| 
|| `200040300040` | Insufficient permissions to create the parent product
|| 
...
|| 
|| `200040300010` | Insufficient permissions to read the trading catalog
|| 
...
|| 
|| `0` | Parent product with the specified symbolic code already exists
|| 
