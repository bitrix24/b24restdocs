...
||
|| **propertyN**
[`any`](../../../data-types.md) | Value of the parent product property, where `N` — property identifier. There can be multiple properties. 
...
|| 
|| `200040300040` | Insufficient rights to create the parent product
|| 
