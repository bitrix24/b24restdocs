...
The `CATALOG.PRODUCT.ON.ADD` event is triggered when a product is added.
...
In this case — `CATALOG.PRODUCT.ON.ADD` ||
|| **event_handler_id***
[`integer`](../../../data-types.md) | Identifier of the event handler ||
|| **data***
[`object`](../../../data-types.md) | An object containing information about the added product.
