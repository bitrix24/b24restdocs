...
>
> Who can execute the method: an authorized user of the application that registered the chatbot. This method only works with bots from this application.

The method `imbot.message.update` modifies a previously sent message from the chatbot.
