...
|| **TO_USER_ID** 
[`unknown`](../../../data-types.md) | Identifier of the bot or user: in a "one-on-one" dialog this will be the bot's identifier, and in a group chat - the identifier of the user to whom the message is directed. If specified as 0 - it means all participants in the chat | ||
|| **TO_CHAT_ID** 
...
|| **IS_NETWORK** 
[`unknown`](../../../data-types.md) | This user is a network user (can be a participant of the OL chat, client, or just an external user), otherwise - N. | ||
|| **IS_EXTRANET** 
