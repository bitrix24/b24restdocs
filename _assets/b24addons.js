const GITHUB_REPO_BASE_URL = "https://github.com/bitrix24/b24restdocs/";
        ...
        function showHint() {
            ...
            resultContainer.innerHTML = `
                <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; color: #666; width: 66.67%; margin: 0 auto; text-align: center;">
                    ...
                    <p>Start looking for the articles you need</p>
                </div>
            `;
            resultContainer.style.display = 'block';
        }
...
function showNoResultsMessage(resultContainer) {
    resultContainer.innerHTML = `
        <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; color: #666; width: 66.67%; margin: 0 auto; text-align: center;">
            ...
            <p>Unfortunately, we couldn’t find anything matching your request. Please try rephrasing it</p>
        </div>
    `;
    resultContainer.style.display = 'block';
}
...
function performSearch(query, resultContainer) {
    ...
    const url = `https://util.bitrixsoft.com/documentation/rest/search.php?q=${encodeURIComponent(query)}`;
    ...
    if (dcControlsDiv) {
        ...
        if (b24Button === null) {
            ...
            const issue_url = `${GITHUB_REPO_BASE_URL}issues/new` +
                ...
                `&body=${encodeURIComponent(`Lint to page: ${currentUrl}`)}`;
...
(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    ...
    })(window,document,'script','dataLayer','GTM-KHZ9R39Z');