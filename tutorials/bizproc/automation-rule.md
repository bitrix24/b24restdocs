# Add an Automation Rule in CRM that Creates an Invoice Based on a Lead or Deal

To use this example, you need to configure the CRest class and include the crest.php file in the files where this class is used. [Learn more](../../how-to-use-examples.md).

## Activity Registration File

{% include [Footnote on examples](../../_includes/examples.md) %}

In the file that registers the activity, you need to change the path `$handlerUrl` to your path to the activity handler.
