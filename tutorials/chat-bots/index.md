...
4. Leave the *Application completes the installation itself* option disabled — otherwise Bitrix24 does not register the `ONAPPINSTALL` event handler and the application does not receive the tokens
