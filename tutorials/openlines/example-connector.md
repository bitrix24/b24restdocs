...
The connector works only within the context of an application (OAuth). An inbound webhook will not work: the `imconnector.*` methods require application authorization.
