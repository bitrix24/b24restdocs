...
**Custom Fields**. Extend the SPA card with your own fields. Creating a field, choosing its type, and writing a value are covered in the [{#T}](../../field-types/index.md) section.
