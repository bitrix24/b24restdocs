# Add Contact with Requisites

> Scope: [`crm`](../../../api-reference/scopes/permissions.md)
>
> Who can execute the method: users with administrative access to the CRM section

Example of embedding a form on a website page, after filling which a new contact is created in Bitrix24 with attached requisites.
            ...
            if (arRequisiteType.error()) {
                ...
                if (arRequisiteType.data().length > 0) {
                    ...
                    document.getElementById('form_to_crm').addEventListener('submit', function(el) {
                        ...
                        fetch('form.php', { // file for saving filled forms
                            method: 'POST',
                            body: formData
                        })
