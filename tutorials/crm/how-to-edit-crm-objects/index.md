...
|| [How to Transfer or Complete Activities of a Terminated Employee](./how-to-transfer-fired-employee-activities.md) | [user.get](../../../api-reference/user/user-get.md), [crm.activity.list](../../../api-reference/crm/timeline/activities/activity-base/crm-activity-list.md), [crm.activity.update](../../../api-reference/crm/timeline/activities/activity-base/crm-activity-update.md), [crm.activity.todo.updateResponsibleUser](../../../api-reference/crm/timeline/activities/todo/crm-activity-todo-update-responsible-user.md), [crm.activity.configurable.get](../../../api-reference/crm/timeline/activities/configurable/crm-activity-configurable-get.md), [crm.activity.configurable.update](../../../api-reference/crm/timeline/activities/configurable/crm-activity-configurable-update.md) | The responsible person is changed or the activities are completed ||
