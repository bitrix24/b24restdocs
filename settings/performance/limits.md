...
Request duration can be affected by the data volume, filter complexity, nested calls in [batch](../how-to-call-rest-api/batch.md), and automation that is launched when the method is executed.
