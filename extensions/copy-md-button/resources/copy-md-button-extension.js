...
`;
  ...
  <path d="M10.25 5.75V3.5a1.25 1.25 0 0 0-1.25-1.25H2.75A1.25 1.25 0 0 0 1.5 3.5v7.5c0 .69.56 1.25 1.25 1.25H5"
    ...
    function showHoverTooltip(btn) {
        ...
        if (textEl) textEl.textContent = btn.getAttribute('aria-label') || 'Copy the page to Markdown';
    ...
    function mountInto(controls) {
        ...
        btn.setAttribute('aria-label', 'Copy the page to Markdown');
